...
```bash
ancla apps status my-org/my-project/my-app
```
...
Now commands like `status`, `logs`, `run`, and `down` know what app you're working on without extra arguments. See [Project Linking](/guides/project-linking/) for details.

## Next steps

- [Project Linking](/guides/project-linking/) — link your directory to skip typing org/project/app on every command
